...
# ==================================================
# Link Hosting Kalian
FItunnel="raw.githubusercontent.com/Fitunnel/AutoScript/main/wireguard"
...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard has been installed, please type addwg to add a client."
	exit 1
fi

echo -e "${Info} Wireguard Script By AlfiStoreVPN"
